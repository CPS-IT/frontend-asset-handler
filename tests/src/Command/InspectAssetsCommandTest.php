 ...
 */
final class InspectAssetsCommandTest extends Tests\CommandTesterAwareTestCase
{
    ...
    private Tests\Fixtures\Classes\DummyVcsProvider $vcsProvider;
    ...
    protected function setUp(): void
    {
        ...
        $this->vcsProvider = new Tests\Fixtures\Classes\DummyVcsProvider();
        ...
        $this->initializeCommandTester(
            ...
            [
                ...
                Provider\ProviderFactory::class => new Provider\ProviderFactory(
                    new DependencyInjection\ServiceLocator([
                        'dummy' => fn () => new Tests\Fixtures\Classes\DummyProvider(),
                    ]),
                ),
