...
namespace CPSIT\FrontendAssetHandler\Tests\Command;
 ...
 */
final class FetchAssetsCommandTest extends Tests\CommandTesterAwareTestCase
{
    use Tests\EnvironmentVariablesTrait;
    use Tests\FunctionExecutorTrait;

    private Tests\Fixtures\Classes\DummyHandler $handler;
    ...
    protected function setUp(): void
    {
        ...
        $this->initializeCommandTester(
            ...
            [
                Processor\ExistingAssetProcessor::class => $this->container->get(Tests\Fixtures\Classes\DummyProcessor::class),
                Asset\Revision\RevisionProvider::class => $this->container->get(Tests\Fixtures\Classes\DummyRevisionProvider::class),
            ],
        );

        $this->handler = $this->container->get(Tests\Fixtures\Classes\DummyHandler::class);
