...
{
    private Tests\Unit\Fixtures\Classes\DefaultConfigurationAwareTraitTestClass $subject;

    protected function setUp(): void
    {
        $this->subject = new Tests\Unit\Fixtures\Classes\DefaultConfigurationAwareTraitTestClass([
            'foo' => 'foo',
            'baz' => null,
        ]);
    }
