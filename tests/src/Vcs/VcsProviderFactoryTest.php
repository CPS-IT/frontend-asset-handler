...
namespace CPSIT\FrontendAssetHandler\Tests\Vcs;
 ...
 */
final class VcsProviderFactoryTest extends Tests\ContainerAwareTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new Vcs\VcsProviderFactory(
            new DependencyInjection\ServiceLocator([
                ...
                // Dummy providers
                'dummy' => fn () => new Tests\Fixtures\Classes\DummyVcsProvider(),
            ]),
        );
    }
    ...
    public function getReturnsInstantiatedProviderOfGivenType(): void
    {
        self::assertInstanceOf(
            Tests\Fixtures\Classes\DummyVcsProvider::class,
