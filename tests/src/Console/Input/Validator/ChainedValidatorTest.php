...
final class ChainedValidatorTest extends TestCase
{
    ...
    private Tests\Fixtures\Classes\DummyValidator $firstValidator;
    private Tests\Fixtures\Classes\DummyValidator $secondValidator;

    protected function setUp(): void
    {
        $this->subject = new Console\Input\Validator\ChainedValidator([
            $this->firstValidator = new Tests\Fixtures\Classes\DummyValidator(),
            $this->secondValidator = new Tests\Fixtures\Classes\DummyValidator(),
        ]);
    }
