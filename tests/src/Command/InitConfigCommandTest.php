 ...
 */
final class InitConfigCommandTest extends Tests\CommandTesterAwareTestCase
{
    private Tests\Fixtures\Classes\DummyStep $firstStep;
    private Tests\Fixtures\Classes\DummyInteractiveStep $secondStep;
    ...
    protected function setUp(): void
    {
        ...
        $this->firstStep = $this->container->get(Tests\Fixtures\Classes\DummyStep::class);
        $this->secondStep = $this->container->get(Tests\Fixtures\Classes\DummyInteractiveStep::class);
